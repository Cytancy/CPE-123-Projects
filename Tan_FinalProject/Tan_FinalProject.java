...
public class Tan_FinalProject extends PApplet {
...
public void setup()
{
  ...
  */
  ...
  scene6Text.add(new fadeTextObj("Dorothy..?",caviardreams150, caviardreams250, color(0xfffd6565)));
  scene6Text.add(new fadeTextObj("Doooorothy?",newgarden150, newgarden250, color(0xffa0c791)));
  scene6Text.add(new fadeTextObj("I've got flowers again..!",jellyka220, jellyka320, color(0xfff5d977)));
  scene6Text.add(new fadeTextObj("Hey girl, you there?",cambria80, cambria180, color(0xffd7acfc)));
  scene6Text.add(new fadeTextObj("Waaaaaake up..?",newgarden150, newgarden250, color(0xffa0c791)));
  ...
  scene6Text.add(new fadeTextObj("Unfortunately.",tnr72, tnr172, color(0xff62728d)));
  scene6Text.add(new fadeTextObj("However, she is showing","signs of improvement.",tnr72, tnr172, color(0xff62728d)));
  scene6Text.add(new fadeTextObj("The recent scans look promising.",tnr72, tnr172, color(0xff62728d)));
  scene6Text.add(new fadeTextObj("Try to be hopeful.",tnr72, tnr172, color(0xff62728d)));
  ...
  scene6Text.add(new fadeTextObj("Yep!",jellyka220, jellyka320, color(0xfff5d977)));
  scene6Text.add(new fadeTextObj("Mhm.",newgarden150, newgarden250, color(0xffa0c791)));
  scene6Text.add(new fadeTextObj("Of course!",cambria80, cambria180, color(0xffd7acfc)));
  ...
  scene6Text.add(new fadeTextObj("Don't worry sir,", "we miss her too." ,jellyka220, jellyka320, color(0xfff5d977)));
  scene6Text.add(new fadeTextObj("Wait!",caviardreams150, caviardreams250, color(0xfffd6565)));
  scene6Text.add(new fadeTextObj("Doctor, she's moving!",cambria80, cambria180, color(0xffd7acfc)));
  scene6Text.add(new fadeTextObj("Her eyes..!",jellyka220, jellyka320, color(0xfff5d977)));
...
//========================Run1===============================
  public void runStart()
  {
    ...
    tint(255,(pass-50)*2*2.55f);
    image(start1,0,0);
    noTint();
    tint(255,(pass-100)*2*2.55f);
    image(start1Temp,0,0);
    noTint();
    
    tint(255,(pass-100)*2*2.55f);
    image(start5,0,(int)(startPass-startPass*.95f));
    noTint();
...
class fadeText
{
  ...
  public void run2()
  {
      ...
      else 
      {
        ...
        text(mainString.substring(0,letters) + "\n" + ((fadeTextObj)stringArray.get(activeString)).getString2(),width/2,height/2+80 - heightOffset*2.2f);    
        noFill();
      }
      //====
  ...
  public void run3()
  {
    ...
    else 
    {
      ...
      if (pass>=50) {inOut=true;}
      if (inOut && pass<7) {inOut=false;}
      tint(255,(int)((pass*2*2.55f)/40));
      image(scene4Text2,0,0);
      noTint();
      tint(255,(int)((pass*2*2.55f)/2));
  ...
  public void run4()
  {
      ...
      if (((fadeTextObj)stringArray.get(activeString)).getString2()==""){
        textFont(((fadeTextObj)stringArray.get(activeString)).getFont());
        textAlign(CENTER);
        fill(0,(pass*2*2.55f)/2);
        text(mainString,width/2,height/2+50);
        fill(0,(pass*2*2.55f)/18);
        text(mainString,width/2,height/2+55);
        textFont(((fadeTextObj)stringArray.get(activeString)).getFont2());
        fill(0,(pass*2*2.55f)/40);
        text(mainString.substring(0,letters),width/2,height/2+80);    
        noFill();
      }
      else 
  ...
  public void run5()
  {
      ...
      if (((fadeTextObj)stringArray.get(activeString)).getString2()==""){
        textFont(((fadeTextObj)stringArray.get(activeString)).getFont());
        textAlign(CENTER);
        fill(((fadeTextObj)stringArray.get(activeString)).getColor(),(pass*2*2.55f)/2);
        text(mainString,width/2,height/2+50);
        fill(((fadeTextObj)stringArray.get(activeString)).getColor(),(pass*2*2.55f)/18);
        text(mainString,width/2,height/2+55);
        textFont(((fadeTextObj)stringArray.get(activeString)).getFont2());
        fill(((fadeTextObj)stringArray.get(activeString)).getColor(),(pass*2*2.55f)/40);
        text(mainString.substring(0,letters),width/2,height/2+80);    
        noFill();
      }
      else 
...
class fadeTextObj
{
  ...
  fadeTextObj(String temp1, PFont temp2, PFont temp3, int tempColor)
  {
    givenString = temp1;
    givenString2 = "";
    givenFont = temp2;
  ...
  fadeTextObj(String temp1, String temp1_1, PFont temp2, PFont temp3 , int tempColor)
  {
    givenString = temp1;
    givenString2 = temp1_1;
    givenFont = temp2;
...
class act
{
  ...
  public void run1()
  {
    ...
    musicPlayer2.setGain(-1.0f*(float)(pass1/250.0f)*28.0f);
    ...
    textFont(actFont2);
    text(subLine,width*1.5f-location,280);
    //================
    tint(255,pass2);
  ...
  public void run2()
  {
    ...
    musicPlayer3.setGain(-1.0f*(float)(pass1/250.0f)*28.0f);
  ...
  public void run3()
  {
    ...
    musicPlayer4.setGain(-1.0f*(float)(pass1/250.0f)*28.0f);
  ...
  public void run4()
  {
    ...
    musicPlayer5.setGain(-1.0f*(float)(pass1/250.0f)*28.0f);
  ...
  public void reset(String temp1, String temp2, int actCountHolder)
  {
...
class transitionRect
{
  ...
  public void setOpacity (int temp)
  {
    opacity=temp;
  }
}
...
class fallParticle
{
  ...
  class speedParticle
  {
    ...
    public void run(int tempX, int tempY)
    {
    ...
    if(!active)
    {
       ...
       else if (characters==2)
       {
         if (dialogueHolder.getActive()==2)
           {tint(255,runner*2*2.55f-opacityDiff);}
         else 
           {tint(255,runner*2*2.55f);}
         image(dialogueHolder.getImage1(),0,0);
         noTint();
...
class dialogue
{
  ...
  public void setExpression1(int temp)
  {
    expression1 = temp;
  }
  
  public void setExpression2(int temp)
  {
    expression2 = temp;
  }
}
...
class worldUnit
{
  ...
  public void jumpSystem()
  {
    if (jumping)
    {
      ...
      if ((int)(random(1,3)) == 2 && jumpVelocity>0 && jumpHeight<-25) {heartSystem.add(new heartParticle((int)(locX-spriteSize/2)+20, (int)(locY-.85f*spriteSize+jumpHeight)+30));}
  ...
  public void runDeath(PVector starttemp, PVector endtemp)
  {
    if (!death) {
      dorothy.loseLife(20);
  ...
  public void speedSystem()
  {
    if(velocityBonus>0)
    {
      if((int)random(0,5.1f-(velocityBonus/2)) == 0) {
        if (velocityBonus<9.5f)
        {
         speedSystem.add(new speedParticle((int)random((locX-spriteSize/2)+17,(locX-spriteSize/2)+42), (int)random((locY-.85f*spriteSize+jumpHeight)+24,(locY-.85f*spriteSize+jumpHeight)+38)));
         speedSystem.add(new speedParticle((int)random((locX-spriteSize/2)+17,(locX-spriteSize/2)+42), (int)random((locY-.85f*spriteSize+jumpHeight)+24,(locY-.85f*spriteSize+jumpHeight)+38))); 
        }   
        else
        {
         speedSystem.add(new speedParticle((int)random((locX-spriteSize/2)+17,(locX-spriteSize/2)+42), (int)random((locY-.85f*spriteSize+jumpHeight)+24,(locY-.85f*spriteSize+jumpHeight)+38),true));
         speedSystem.add(new speedParticle((int)random((locX-spriteSize/2)+17,(locX-spriteSize/2)+42), (int)random((locY-.85f*spriteSize+jumpHeight)+24,(locY-.85f*spriteSize+jumpHeight)+38), true)); 
        }      
      }
    }
  ...
  public void loseLife(int amountLost)
  {
    life-=amountLost;
    if (life<=0) {exit();}
  }
  ...
  public void runWalk()
  {
    if(skill1){velocity=1;}
      ...
      pushMatrix();
        ...
        imageMode(CORNER);
        popMatrix();
      image(active, locX-spriteSize/2, locY-.85f*spriteSize+jumpHeight);
  }
}
//====================================================================================
//|                                   ***********                                    |
...
class hub
{
  ...
  hub()
  {
    ...
    for (int i=0; i<101; i++)
    {
      lifeBarLevels.add(lifeBar.get(0,0, (int)((float)lifeBar.width*((float)i/100.0f)), lifeBar.height));
    }
  }
...
class map1
{
  ...
  public void run()
  {
    ...
    if (skill1Counter>0)
    {
      tint(255,skill1Counter*2.55f*2);
  ...
  public void skill1Button()
  {
    if (m1Trigger3)
    {
      if (skill1Opacity<50) {skill1Opacity++; tint(255,skill1Opacity*2*2.55f);
  ...
  public void triggerSystem()
  {
    ...
    if (m1Trigger5) {BGM1.setGain(((float)(transitionSystem.getPass())/(float)(transitionSystem.getSpeed()))*(28.0f)*(-1.0f));}
  ...
  public boolean triggerCheck(PVector upperbound, PVector lowerbound)
  {
...
class map2
{
  ...
  public void triggerSystem()
  {
    ...
    {
      m2Trigger2 = true;
      respawnDown = new PVector(-2282.5f,-906.96f);
    }
   ...
   //===================
   if (triggerCheck(new PVector (-946.399f,107.5f), new PVector(-1170.15f, 14)) && !m2Trigger5)
   {
     m2Trigger5 = true;
   ...
   if (m2Trigger6)
   {
     ...
     if (skill2Opacity<50) {skill2Opacity++; tint(255,skill2Opacity*2*2.55f);
   ...
   if (m2Trigger9) {BGM2.setGain(((float)(transitionSystem.getPass())/(float)(transitionSystem.getSpeed()))*(28.0f)*(-1.0f));}
...
class platform
{
  ...
  public void run(int temp1, int temp2, int temp3)
  {
...
class map3
{
  ...
  public void triggerSystem()
  {
    if (triggerCheck(new PVector (24.5f,-487.36f), new PVector(-66, -707)) && !m3Trigger1)
    {
      m3Trigger1 = true;
   ...
   if (m3Trigger8) {BGM3.setGain(((float)(transitionSystem.getPass())/(float)(transitionSystem.getSpeed()))*(28.0f)*(-1.0f));}
...
class map4
{
  ...
  map4()
  {
    ...
    bloodOn = false;
    respawnUp = new PVector((int)locX,(int)locY);
    respawnDown =  new PVector (33,-8.27f);
  }
  ...
  public void triggerSystem()
  {
    ...
    if (m4Trigger7) {BGM4.setGain(((float)(transitionSystem.getPass())/(float)(transitionSystem.getSpeed()))*(28.0f)*(-1.0f));}
...
public void keyReleased ()
{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F5F5F5", "Tan_FinalProject" });
  }
}
